...
export type IAuthenticate<T> =
	| ((credentials: T, requestOptions: IHttpRequestOptions) => Promise<IHttpRequestOptions>)
...
export interface ICredentialType<T = object> {
	name: string;
	displayName: string;
	icon?: string;
	iconUrl?: string;
...
export type ICredentialTypeData<T = object> = LoadedData<ICredentialType<T>>;
